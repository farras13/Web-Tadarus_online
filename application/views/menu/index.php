                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('menu/delet/').$m['id']; ?>" class="badge badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<!-- Modal -->
<?php foreach ($menu as $m) : ?>
<div class="modal fade" id="editMenuModal<?= $m['id'];?>" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newMenuModalLabel">Add New Menu</h5>
